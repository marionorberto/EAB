                    ...
                    <table id="myTable" class="table table-hover small-fs-6">
                        ...
                        <tbody class="text-muted text-opacity-50 fs-6">
                            <?php if(@count($consultas)<= 0): ?> <tr>
                                ...
                                <tr class="md-fs-6">
                                    <td>
                                        <?php echo e($consulta->cod); ?>

                                    </td>
                                    <td>
                                        <?php echo e($consulta->firstname_doutor); ?> <?php echo e($consulta->lastname_doutor); ?>

                                    </td>
                                    <td>
                                        <?php echo e($consulta->nome_especialidade); ?>

                                    </td>
                                    <td>
                                        <?php echo e($consulta->firstname_paciente); ?> <?php echo e($consulta->lastname_paciente); ?>
