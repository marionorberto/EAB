            ...
            <div class="row">
                <div class="col-12 col-lg-2 col-md-3">
                    <a class="navbar-brand " href="index.html">
                        <span class="fw-bold">EAB</span> <br> <span class="fw-light fs-6 fst-italic">Efortless
                            Appointment
                            Booking</span>
                    </a>
                </div>
                ...
                <div class="col-12 col-lg-2 col-md-3 text-right">
                    <a href="#appointment" class="appointment-btn">Marcar Consulta</a>
                </div>
            </div>
        </div>
    </nav>
                        ...
                        <div class="col-lg-7 col-md-12">
                            <div class="hero-slides owl-carousel owl-theme">
                                <div class="hero-content">
                                    ...
                                    <a href="#" class="btn">Marcar Consulta Agora</a>
                                </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-4 col-md-12">
                    <div class="section-title">
                        <h3>Quem sómos</h3>
                        <span>Em encontre o melhor doctor para si</span>
                    </div>
                    ...
                    <div class="who-we-are-text">
                        ...
                        <a href="#" class="btn">Marcar Agora</a>
                    </div>
                </div>
                        ...
                        <div class="tab_content">
                                ...
                                <div class="row align-items-center">
                                    ...
                                    <div class="col-lg-6 col-md-12">
                                        <div class="tabs_item_content">
                                            ...
                                            <p>This department provides medical care to patients who have problems with
                                                their heart or circulation. It treats people on an inpatient and
                                                outpatient basis.</p>
                                            <ul>
                            ...
                            <div class="tabs_item">
                                <div class="row align-items-center">
                                    ...
                                    <div class="col-lg-6 col-md-12">
                                        <div class="tabs_item_content">
                                            <h3>Departamento de Orthopedia</h3>
                                            <p>This department provides medical care to patients who have problems with
                                                their heart or circulation. It treats people on an inpatient and
                                                outpatient basis.</p>
                                            <ul>
                                                <li>Electrocardiograma (ECG)</li>
                                                <li>Eocardiograma (ultrasound scan of the heart)</li>
                                                <li>24-hora testes - pressão sanguínea</li>
                                            </ul>
                                            <a href="#" class="btn">Marcar Agora</a>
                                        </div>
                                    </div>
                    ...
                    <div class="faq">
                        <ul class="accordion">
                            <li class="accordion-item">
                                <a class="accordion-title active" href="javascript:void(0)">What is dental care? <i
                            ...
                            <li class="accordion-item">
                                <a class="accordion-title" href="javascript:void(0)">What is dental care? <i
                                        class="icofont-plus"></i></a>
                    ...
                    <div class="appointment-form">
                        <form>
                            <div class="row">
                                ...
                                <div class="col-lg-12">
                                    <button type="submit" class="btn">Agenda Agora</button>
                                </div>
                            </div>
                        </form>
                    </div>
            ...
            <div class="row">
                <div class="col-lg-3 col-md-6">
                    <div class="single-services">
                        ...
                        <p>Our talented, board-certified and fellowship-trained plastic surgeons have more than 42 years
                            of combined experience helping patients look and feel their best.</p>
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="pricing-table">
                        ...
                        <div class="pricing-footer">
                            <a href="#" class="btn">Marque Agora</a>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="single-feedback">
                        ...
                        <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod incididunt ut labore
                            et dolore magna aliqua. Risus commodo viverra maecenas accumsan lacus vel facilisis.</p>
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="single-blog-post">
                        ...
                        <div class="post-content">
                            <h4><a href="single-blog.html">Risus commodo viverra maecenas accumsan lacus vel
                                    facilisis.</a></h4>
                            <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt
                                ut labore et dolore magna aliqua.</p>
                            <a href="single-blog.html" class="btn">Leia Mais</a>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-3 col-md-6">
                    <div class="contact-box">
                        ...
                        <p><a href="https://www.google.com/maps/place/Exercisplan+4,+111+49+Stockholm,+Sweden/data=!4m2!3m1!1s0x465f9d5641a77669:0xe02744b36aab9f53?ved=2ahUKEwi38ZaU0rXfAhVWeH0KHY5CBWYQ8gEwAHoECAAQAQ"
                                target="_blank">Exercisplan 4, 111 49 <br> Stockholm,Sweden</a></p>
                    </div>
                </div>
                ...
                <div class="col-lg-3 col-md-6">
                    <div class="contact-box">
                        ...
                        <p><a href="#"><span class="__cf_email__"
                                    data-cfemail="e48d8a828ba4808b87908b96ca878b89">[email&#160;protected]</span></a>
                        </p>
                        <p><a href="#"><span class="__cf_email__"
                                    data-cfemail="ccbfb9bcbca3beb88ca8a3afb8a3bee2afa3a1">[email&#160;protected]</span></a>
                        </p>
                    </div>
                </div>
...
</html><?php /**PATH /home/kenny/Documents/ProjectsPHP/usefullsystem/resources/views/welcome.blade.php ENDPATH**/ ?>