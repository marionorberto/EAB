    ...
    <section class="d-flex gap-0 w-full w-100 text-white list-unstyled fw-medium">
        <div
            ...
            <div class="mt-3 align-self-start ms-2 text-secondary mb-3">
                <img src="{{URL::to('storage/userPhotos/R7uByBaME4W3H9PGQEMsvnPBUbvf07davkWfviN0.jpg')}}" alt=""
            ...
            <div class="mt-2">
                ...
                <ul class="list-unstyled d-flex flex-column gap-2 mt-2 position-relative w-full">
                    <li class="dashboard-sl-li"><a href="{{route('dashboard-paginas-usuarios')}}"><i class="icofont-user text-secondary">
                            </i> Usuários</a></li>
                    <li class="dashboard-sl-li"><a href="{{route('dashboard-paginas-colaboradores')}}"> <i class="icofont-doctor text-secondary">
                            </i> Colaboradores</a></li>
                    <li class="dashboard-sl-li"s><a href="{{route('dashboard-paginas-especialidades')}}"> <i class="icofont-card text-secondary">
            ...
            <div>
                ...
                <ul class="list-unstyled d-flex flex-column gap-2 mt-2 position-relative w-full">
                    <li class="dashboard-sl-li2"><a href="{{route('dashboard-analises-consultas')}}"><i class="icofont-crutch text-secondary">
                            </i> Consultas</a></li>
                    <li class="dashboard-sl-li2"><a href="{{route('dashboard-analises-pacientes')}}"><i class="icofont-operation-theater text-secondary">
                            </i> Pacientes</a></li>
                    <li class="dashboard-sl-li2"><a href="{{route('dashboard-analises-financeiro')}}"><i class="icofont-money text-secondary">
                            </i>Finaceiro</a></li>
                </ul>
            </div>
            <div>
                ...
                <ul class="list-unstyled d-flex flex-column gap-2 mt-2 position-relative w-full">
                    <li class="dashboard-sl-li3"><a href="{{route('dashboard-usuario-settings')}}">
                            <i class="icofont-settings text-secondary">
                            </i>Settings
                        </a></li>
                    <li class="dashboard-sl-li3"><a href="{{route('dashboard-usuario-help')}}"><i class="icofont-support text-secondary">
                            </i> Help</a></li>
