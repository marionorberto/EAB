        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-12 col-lg-2 col-md-3 text-right">
                    <a href="{{route('consultas.index')}}" class="appointment-btn nowrap w-75 h-75">Marcar Consulta</a>
                </div>
            </div>
        </div>
    </nav>
                ...
                <div class="col-lg-6 col-md-12">
                    <div class="row about-image">
                        <div class="col-6 col-lg-6 col-md-6">
                            <div class="image">
                                <img src="{{URL::to('img/about-img1.jpg')}}" alt="about">
                            </div>
                        </div>

                        <div class="col-6 col-lg-6 col-md-6">
                            <div class="image">
                                <img src="{{URL::to('img/about-img2.jpg')}}" alt="about">
                            </div>
                        </div>

                        <div class="col-6 col-lg-6 col-md-6">
                            <div class="image mt-30">
                                <img src="{{URL::to('img/about-img3.jpg')}}" alt="about">
                            </div>
                        </div>

                        <div class="col-6 col-lg-6 col-md-6">
                            <div class="image mt-30">
                                <img src="{{URL::to('img/about-img4.jpg')}}" alt="about">
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="tab_content">
                                ...
                                <div class="row align-items-center">
                                    <div class="col-lg-6 col-md-12">
                                        <div class="tabs_item_img">
                                            <img src="{{URL::to('img/cardiologia.jpg')}}" alt="department">
                                        </div>
                                    </div>
                            ...
                            <div class="tabs_item">
                                <div class="row align-items-center">
                                    <div class="col-lg-6 col-md-12">
                                        <div class="tabs_item_img">
                                            <img src="{{URL::to('img/neurologia.jpg')}}" alt="department">
                                        </div>
                                    </div>
                            ...
                            <div class="tabs_item">
                                <div class="row align-items-center">
                                    <div class="col-lg-6 col-md-12">
                                        <div class="tabs_item_img">
                                            <img src="{{URL::to('img/ortopedia.jpg')}}" alt="department">
                                        </div>
                                    </div>
                            ...
                            <div class="tabs_item">
                                <div class="row align-items-center">
                                    <div class="col-lg-6 col-md-12">
                                        <div class="tabs_item_img">
                                            <img src="{{URL::to('img/radiologia.jpg')}}" alt="department">
                                        </div>
                                    </div>
                            ...
                            <div class="tabs_item">
                                <div class="row align-items-center">
                                    <div class="col-lg-6 col-md-12">
                                        <div class="tabs_item_img">
                                            <img src="{{URL::to('img/fun-facts-bg.jpg')}}" alt="department">
                                        </div>
                                    </div>
                            ...
                            <div class="tabs_item">
                                <div class="row align-items-center">
                                    <div class="col-lg-6 col-md-12">
                                        <div class="tabs_item_img">
                                            <img src="{{URL::to('img/department-img1.jpg')}}" alt="department">
                                        </div>
                                    </div>
                ...
                <div class="row">
                    <div class="col-lg-4 col-md-6 mix cardiology">
                        <div class="single-photo">
                            <img src="{{URL::to('img/gallery-img1.jpg')}}" alt="gallery">
                    ...
                    <div class="col-lg-4 col-md-6 mix neurology">
                        <div class="single-photo">
                            <img src="{{URL::to('img/gallery-img2.jpg')}}" alt="gallery">
                            <div class="gallery-content">
                    ...
                    <div class="col-lg-4 col-md-6 mix sergury">
                        <div class="single-photo">
                            <img src="{{URL::to('img/gallery-img3.jpg')}}" alt="gallery">
                            <div class="gallery-content">
                    ...
                    <div class="col-lg-4 col-md-6 mix orthopaedics">
                        <div class="single-photo">
                            <img src="{{URL::to('img/gallery-img4.jpg')}}" alt="gallery">
                            <div class="gallery-content">
                    ...
                    <div class="col-lg-4 col-md-6 mix urology">
                        <div class="single-photo">
                            <img src="{{URL::to('img/gallery-img5.jpg')}}" alt="gallery">
                            <div class="gallery-content">
                    ...
                    <div class="col-lg-4 col-md-6 mix orthopaedics cardiology">
                        <div class="single-photo">
                            <img src="{{URL::to('img/gallery-img6.jpg')}}" alt="gallery">
                            <div class="gallery-content">
                                <h3>Exames Urológicos</h3>
                                <span>Urologia</span>
                                <a href="{{route('consultas.index')}}" class="link-btn"><i class="icofont-link"></i></a>
            ...
            <div class="row">
                <div class="col-lg-4 col-md-6">
                    <div class="single-feedback">
                        <div class="client-info">
                            <div class="img">
                                <img src="{{URL::to('img/client-avatar1.jpg')}}" class="img-reduced" alt="client')">
                            </div>
                            <h4>Milton Cunha</h4>
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="single-feedback">
                        <div class="client-info">
                            <div class="img">
                                <img src="{{URL::to('img/client-avatar3.jpg')}}" alt="client')">
                            </div>
                            <h4>Milagre Silva</h4>
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="single-feedback">
                        <div class="client-info">
                            <div class="img">
                                <img src="{{URL::to('img/client-avatar7.jpg')}}" alt="client">
                            </div>
                            <h4>Paulo Correia</h4>
                            <span>Advogado</span>
                        </div>
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="single-feedback">
                        <div class="client-info">
                            <div class="img">
                                <img src="{{URL::to('img/client-avatar5.jpg')}}" alt="client" class="img-reduced">
                            </div>
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="single-feedback">
                        <div class="client-info">
                            <div class="img">
                                <img src="{{URL::to('img/client-avatar4.jpg')}}" alt="client" class="img-reduced">
                            </div>
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="single-feedback">
                        <div class="client-info">
                            <div class="img">
                                <img src="{{URL::to('img/client-avatar6.jpg')}}" alt="client">
                            </div>
                            <h4>Ana Bela</h4>
                            <span>Estundate</span>
                        </div>
            ...
            <div class="row">
                <div class="col-lg-4 col-md-6">
                    <div class="single-blog-post">
                        <a href="single-blog.html" class="blog-img"><img src="{{URL::to('img/blog-img1.jpg')}}"
                                alt="blog"></a>
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="single-blog-post">
                        <a href="single-blog.html" class="blog-img"><img src="{{URL::to('img/blog-img2.jpg')}}"
                                alt="blog"></a>
                ...
                <div class="col-lg-4 col-md-6 offset-lg-0 offset-md-3">
                    <div class="single-blog-post">
                        <a href="single-blog.html" class="blog-img"><img src="{{URL::to('img/blog-img3.jpg')}}"
                                alt="blog"></a>
