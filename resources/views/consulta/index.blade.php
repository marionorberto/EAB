...
<body class="pb-4 body-login">
            ...
            <div id="" class="consulta-section-left d-flex flex-column gap-3">
                <a class="navbar-brand align-self-top ps-5 pt-5 mt-5" href="http://localhost:8000/">
                    ...
                    <span class="fw-bolder fs-5 text-light fs-2"> EAB</span> <br> <span
                        class="fs-6 fst-italic text-white fw-bold lh-sm">Efortless
                        Appointment
                        Booking</span>
                </a>
                <h2 class="text-white ms-5">Marque a sua consulta <br> <strong>hoje mesmo.</strong></h2>
                <img src="{{URL::to('img/undraw_doctor_kw-5-l.svg')}}" alt="">
            </div>
            <form action="{{route('consultas.store')}}" method="post" class="
                ...
                <div class="d-flex gap-5 w-100 mt-4">
                    <div class="">
                        ...
                        <input type="text" class="text-primary input-consulta" value="{{old('firstname')}}"
                            name="firstname">
                    </div>
                    <div>
                        <label for="" class="text-primary fw-light d-block">Último Nome</label>
                        <input type="text" value="{{old('lastname')}}" class="text-primary input-consulta"
                            name="lastname">
                    </div>
                </div>
                ...
                <div class="d-flex gap-5 w-100 mt-4">
                    ...
                    <div>
                        ...
                        <input type="tel" class="text-primary input-consulta" value=" {{old('telefone')}}"
                            name="telefone">
                    </div>
                    <div>
                        <label for="" class="text-primary fw-light d-block">Idade</label>
                        <input type="number" name="idade" value="{{old('idade')}}" id="" min="0" max="90" value="0"
                ...
                <div class="d-flex gap-5 w-100 mt-4">
                    {{-- <div class="anime">
                        <dotlottie-player
                            src="https://lottie.host/f98347fe-c0e3-44f3-bdf8-d45b20df20c3/LrBll9McpP.lottie"
                            background="transparent" speed="1" style="width: 300px; height: 300px;" loop autoplay>
                        </dotlottie-player>
                    </div> --}}
                    <div>
                        <label for="" class="text-primary fw-light d-block">Data de Consulta</label>
                        <input type="date" min="2024-05-01" value="{{old('data')}}" max="2024-12-31" name="data" id=""
                    ...
                    <div class="">
                        ...
                        <select name="doutor" {{old('doutor')}} id="doutor"
    ...
    <script src="{{URL::to('three2.min.js')}}"></script>
