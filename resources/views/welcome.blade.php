        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-12 col-lg-2 col-md-3 text-right">
                    <a href="{{route('consulta.index')}}" class="appointment-btn">Marcar Consulta</a>
                </div>
            </div>
        </div>
    </nav>
                        ...
                        <div class="col-lg-7 col-md-12">
                            <div class="hero-slides owl-carousel owl-theme">
                                <div class="hero-content">
                                    ...
                                    <a href="{{route('consulta.index')}}" class="btn">Marcar Consulta Agora</a>
                                </div>
            ...
            <div class="row">
                <div class="col-lg-4 col-md-12">
                    ...
                    <div class="who-we-are-text">
                        ...
                        <a href="{{route('consulta.index')}}" class="btn">Marcar Agora</a>
                    </div>
                </div>
                                ...
                                <div class="row align-items-center">
                                    ...
                                    <div class="col-lg-6 col-md-12">
                                        <div class="tabs_item_content">
                                            ...
                                            <a href="{{route('consulta.index')}}" class="btn">Marcar Consulta</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="appointment-form">
                        <form>
                            <div class="row">
                                ...
                                <div class="col-lg-12">
                                    <a href="{{route('consulta.index')}}" type="submit" class="btn">Agenda Agora</a>
                                </div>
                            </div>
                        </form>
                    </div>
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="pricing-table">
                        ...
                        <div class="pricing-footer">
                            <a href="{{route('consulta.index')}}" class="btn">Marque Agora</a>
                        </div>
                    </div>
                </div>
            ...
            <div class="row">
                <div class="col-lg-4 col-md-6">
                    <div class="single-feedback">
                        <div class="client-info">
                            <div class="img">
                                <img src="{{URL::to('img/client-avatar1.jpg')}}" alt="client')">
                            </div>
                            <h4>Milton Cunha</h4>
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="single-feedback">
                        <div class="client-info">
                            <div class="img">
                                <img src="{{URL::to('img/client-avatar2.jpg')}}" alt="client')">
                            </div>
                            <h4>Milagre Silva</h4>
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="single-feedback">
                        <div class="client-info">
                            <div class="img">
                                <img src="{{URL::to('img/client-avatar4.jpg')}}" alt="client">
                            </div>
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="single-feedback">
                        <div class="client-info">
                            <div class="img">
                                <img src="{{URL::to('img/client-avatar5.jpg')}}" alt="client">
                            </div>
